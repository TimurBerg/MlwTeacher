...
4) Для поиска лучшей модели построен пайплайн, которые состоит из 3 шагов, на 1-2 предобрабатывает данные, использую разные кодировщики и стандартизацию, после чего перебирает 4 классические модели МО (Дерево решений, К-соседей, Лог.рег., SVC), и методом кросс-валдиации, случайным способом из списка выбирает гиперпараметры, показавшие лучшее качество на метрике ROC-AUC.
